			...
			<form action="addok" method="post">
				<div class="row g-3">
					...
					<div class="col-md-3">
						<label for="email" class="form-label">성별</label> <input
							type="text" class="form-control" name="sex">
					</div>
				...
				<div class="col-12">
					<label for="english" class="form-label">영어구사 여부</label> <input
						...
						placeholder="ex) 유창함 or 생활영어 가능 or 못함">
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<button class="w-100 btn btn-warning btn-lg" onclick="goBack()">돌아가기</button>
					</div>
					<div class="col-sm-3">
